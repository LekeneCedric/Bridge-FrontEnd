...
@Component({
  ...
  templateUrl: './modal-galerie-association.page.html',
  styleUrls: ['./modal-galerie-association.page.scss'],
})
export class ModalGalerieAssociationPage implements OnInit {
