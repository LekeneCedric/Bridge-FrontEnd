...
/* harmony import */ var src_app_services_photo_photo_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/services/photo/photo.service */ 88);
/* harmony import */ var _capacitor_geolocation__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @capacitor/geolocation */ 7621);
/* harmony import */ var _ionic_native_native_geocoder_ngx__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @ionic-native/native-geocoder/ngx */ 9036);
/* harmony import */ var base64_arraybuffer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! base64-arraybuffer */ 478);
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! moment */ 6908);
...
let CreationDonsPage = class CreationDonsPage {
  constructor(creationService, mediaService, navCtrl, actionSheetController, photoService, nativGeocoder, loadingController, http, toast, router) {
  ...
  ngOnInit() {
    ...
    return (0,_home_code237_Documents_GitHub_Bridge_FrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      yield _capacitor_geolocation__WEBPACK_IMPORTED_MODULE_6__.Geolocation.watchPosition({
      ...
      const mycoordinate = yield _capacitor_geolocation__WEBPACK_IMPORTED_MODULE_6__.Geolocation.getCurrentPosition();
  ...
  createDonation() {
    ...
    return (0,_home_code237_Documents_GitHub_Bridge_FrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      const donation = {
        ...
        adresse: _this2.myAdress
      };

      _this2.creationService.createDon(donation, token).toPromise().then(data => {
        _this2.navBack(); //creation don 


        console.log('etape1');
        let formData = new FormData();

        _this2.selectedImages.forEach(img => {
          formData.append('files', img);
        });

        formData.append('donateur_id', uid);
        const api = src_environments_environment__WEBPACK_IMPORTED_MODULE_10__.environment.apiURL + '/medias';
        ...
        let fd = {
          donateur_id: uid,
          files: _this2.selectedImages
        };

        _this2.http.post(api, fd, {
          headers: headers
  ...
  get validationDonation() {
    let res = false;
    this.selectedImages.length >= 1 && this.selectedTitle != '' && this.selectedDescription != '' && this.selectedDisponibility != '' && this.selectedState != '' && this.selectedCategory != '' && this.selectedLongitude != null && this.selectedLatitude != null ? res = true : null;
    return res;
  }
  ...
  getPicture() {
    this.photoService.getPicture().then(data => {
      // console.log(data);
      const blob = new Blob([new Uint8Array((0,base64_arraybuffer__WEBPACK_IMPORTED_MODULE_8__.decode)(data.base64String))], {
        type: `image/${data.format}`
      });
      const file = new File([blob], `${new Date().getTime() + `.${blob.type.replace('image/', '')}`}`, {
        lastModified: moment__WEBPACK_IMPORTED_MODULE_9__().unix(),
        type: blob.type
      });
      console.log(blob);
      console.log(file);
      console.log(blob.type.replace('image/', ''));
...
CreationDonsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_14__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_15__.Component)({
