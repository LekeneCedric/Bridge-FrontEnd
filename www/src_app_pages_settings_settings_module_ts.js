...
const routes = [
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_settings_mes-associations_mes-associations_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./mes-associations/mes-associations.module */ 62474)).then(m => m.MesAssociationsPageModule)
    },
    {
        path: 'mes-mouvements',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_settings_mes-mouvements_mes-mouvements_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./mes-mouvements/mes-mouvements.module */ 15312)).then(m => m.MesMouvementsPageModule)
    },
    {
        path: 'mes-favoris',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_javascript-time-ago_locale_fr_json_js-node_modules_javascript-time-ago_m-f2b7d5"), __webpack_require__.e("src_app_pages_settings_mes-favoris_mes-favoris_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./mes-favoris/mes-favoris.module */ 62039)).then(m => m.MesFavorisPageModule)
    }
];
...
/* harmony import */ var _settings_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./settings.page.html?ngResource */ 30869);
/* harmony import */ var _settings_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./settings.page.scss?ngResource */ 60297);
