...
const routes = [
    ...
    {
        path: 'annonces/:id',
        loadChildren: () => Promise.all(/*! import() */[__webpack_require__.e("default-node_modules_javascript-time-ago_locale_fr_json_js-node_modules_javascript-time-ago_m-f2b7d5"), __webpack_require__.e("src_app_pages_settings_annonces_annonces_module_ts")]).then(__webpack_require__.bind(__webpack_require__, /*! ./annonces/annonces.module */ 5475)).then(m => m.AnnoncesPageModule)
    }
];
...
let SettingsPage = class SettingsPage {
  constructor(route, manageDataService, alertController, authService) {
    this.route = route;
