...
/* harmony import */ var _register_page_html_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./register.page.html?ngResource */ 85250);
/* harmony import */ var _register_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register.page.scss?ngResource */ 54390);
...
let RegisterPage = class RegisterPage {
  constructor(fb, authService, loadingController, toast, http, manageDataService, router) {
    this.fb = fb;
  ...
  ngOnInit() {
    ...
    this.credential = this.fb.group({
      ...
      surname: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.minLength(4)]],
      email: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.email]],
      birthday: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.pattern("")]],
      gender: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required]],
      contact: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.pattern("^((\\+91-?)|0)?[0-9]{9}$")]],
  ...
  signUP() {
    ...
    return (0,_home_code237_Documents_GitHub_Bridge_FrontEnd_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.authService.signup(credential).toPromise().then( /*#__PURE__*/function () {
        ...
        _this.manageDataService.setNotification(notification).toPromise().then(data => {
          console.log(data);
        });
      });
    })();
